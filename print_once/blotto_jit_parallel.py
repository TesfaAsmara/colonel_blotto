...
def play_game(i, j, player1, player2, numCastles, numTroops):
    ...
    filename = f"/home/jovyan/data3/results/C{numCastles:02}_T{numTroops:03}/{i}_{j}_{result}.txt"
...
def tournament(numCastles, numTroops):
    ...
    foldername = f"/home/jovyan/data3/results/C{numCastles:02}_T{numTroops:03}"
    ...
    delayed(play_game)(i, j, player1, strategies[j], numCastles, numTroops) 
